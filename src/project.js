          ...
          gameEnd1: function () {
            ...
            1 == t
              ...
              ? ((this.gameOverT1.string = "\uac8c\uc784 \uc885\ub8cc"),
                (this.gameOverT2.string =
                  "\ud074\ub9ad \ud558\uc5ec \uc810\uc218 \ubcf4\uae30"))
              : ((this.gameOverT1.string = "复旦大学“止水映人间——王纲怀先生捐赠铜镜展”展期为2021年5月15日——9月30日，欢迎各位老师和同学前往复旦大学博物馆300号楼观展。"),
                              ...
                              window.setTimeout(function () {
                                switch (o.fruitNumber) {
                                  ...
                                  case 8:
                                    ...
                                    break;
                                  case 9:
                                    alert("双喜铭五福有柄镜\n时代：清末民初\n这枚铜镜为清末民初的双喜铭五福有柄镜。西方的玻璃镜在清中晚期传入中国。民国以后传统铜镜几乎绝迹，此镜应是中国铜镜的尾声。镜背中央为“囍”字，外圈有五只蝙蝠，寓意“五福临门”，反映了清末民初的婚恋习俗。下方中央是当时铜镜作坊的商号“茂源字号”。");
                                    isFirst[9] = false;
                                    break;
                                }
                              }, 1000);
